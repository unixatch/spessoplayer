 ...
 * @param {Number}              [sampleRate=48000]      sample rate of the data
 * @param {String}              [rawMode]               type of raw (pcm) to use
 * @param {Boolean}             [sendEOF=true]          if it should send EOF after pipe finishes
 */
  //-| cli.mjs |-//
/**
